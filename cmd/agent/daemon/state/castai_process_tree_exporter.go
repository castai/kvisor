...
func (c *CastaiProcessTreeExporter) Run(ctx context.Context) error {
	...
	sender := &processTreeSender{
		...
		sendMetric:      metrics.AgentExporterSendTotal.WithLabelValues("castai_process_tre_events"),
		sendErrorMetric: metrics.AgentExporterSendErrorsTotal.WithLabelValues("castai_process_tree_events"),
	}
