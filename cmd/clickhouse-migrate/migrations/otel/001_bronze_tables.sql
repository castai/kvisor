-- +goose Up
-- =============================================================================
-- BRONZE LAYER — Raw OTLP metrics from OTEL Collector ClickHouse exporter
-- =============================================================================
-- These tables match the OTEL Collector ClickHouse exporter's default schema.
...
TTL toDateTime(TimeUnix) + INTERVAL 4 HOUR
