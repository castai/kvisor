// Adapted from https://github.com/aquasecurity/trivy (pkg/fanal/analyzer/language/golang/binary).
...
import (
	...
	"github.com/castai/kvisor/cmd/imagescan/trivy/golang/parser/binary"
)

func Register() {
	analyzer.DeregisterAnalyzer(analyzer.TypeGoBinary)
