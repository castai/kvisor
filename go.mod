...
// Pin docker to v27 for trivy/image-analyzer compatibility; v28 changes the
// client API in ways that break image daemon scanning.
replace github.com/docker/docker => github.com/docker/docker v27.5.1+incompatible

// Pin testcontainers-go to v0.35.0 (docker v27 compatible). clickhouseexporter
// v0.145.0 bumps it to v0.40.0 which requires docker v28 – incompatible with
// the pin above.
