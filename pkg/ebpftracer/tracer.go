...
type Config struct {
	...
	WorkloadProfileEventsRingBufferSize uint32 `validate:"required"`
	...
	WorkloadProfileEngine  *workloadprofile.WorkloadProfileEngine
...
func (t *Tracer) Run(ctx context.Context) error {
	...
	errg.Go(func() error {
		return t.workloadProfileEventsReadLoop(ctx)
	})
	errg.Go(func() error {
...
func (t *Tracer) workloadProfileEventsReadLoop(ctx context.Context) error {
	return t.runPerfBufReaderLoop(ctx, t.module.objects.WorkloadProfileEvents)
}
