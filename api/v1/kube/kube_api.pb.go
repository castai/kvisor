...
var file_api_v1_kube_kube_api_proto_rawDesc = []byte{
	...
	0x5f, 0x63, 0x69, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x6f, 0x64,
	0x73, 0x43, 0x69, 0x64, 0x72, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x5f, 0x63, 0x69, 0x64, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x65, 0x72,
...
var file_api_v1_kube_kube_api_proto_goTypes = []interface{}{
...
func file_api_v1_kube_kube_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_kube_kube_api_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_kube_kube_api_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_kube_kube_api_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_kube_kube_api_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_kube_kube_api_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IPInfo); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v1_kube_kube_api_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_kube_kube_api_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_kube_kube_api_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pod); i {
			case 0:
				return &v.state
			case 1:
