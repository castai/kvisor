...
func (x *AWSDiskAttachment) Reset() {
	*x = AWSDiskAttachment{}
...
func (x *AWSDiskAttachment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSDiskAttachment) ProtoMessage() {}

func (x *AWSDiskAttachment) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_kube_kube_api_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AWSDiskAttachment.ProtoReflect.Descriptor instead.
func (*AWSDiskAttachment) Descriptor() ([]byte, []int) {
	return file_api_v1_kube_kube_api_proto_rawDescGZIP(), []int{26}
}

func (x *AWSDiskAttachment) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
func (x *AWSDiskAttachment) GetDevice() string {
	if x != nil {
		return x.Device
	}
	return ""
...
type AWSCloudVolumeInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Attachments   []*AWSDiskAttachment   `protobuf:"bytes,1,rep,name=attachments,proto3" json:"attachments,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AWSCloudVolumeInfo) GetAttachments() []*AWSDiskAttachment {
	if x != nil {
...
const file_api_v1_kube_kube_api_proto_rawDesc = "" +
	...
	"\avolumes\x18\x01 \x03(\v2\x18.kube.v1.CloudVolumeInfoR\avolumes\"L\n" +
	"\x11AWSDiskAttachment\x12\x1f\n" +
	"\vinstance_id\x18\x01 \x01(\tR\n" +
	"instanceId\x12\x16\n" +
	"\x06device\x18\x02 \x01(\tR\x06device\"R\n" +
	"\x12AWSCloudVolumeInfo\x12<\n" +
	"\vattachments\x18\x01 \x03(\v2\x1a.kube.v1.AWSDiskAttachmentR\vattachments\"\xf5\x02\n" +
	...
	"\baws_info\x18\n" +
	" \x01(\v2\x1b.kube.v1.AWSCloudVolumeInfoH\x00R\aawsInfoB\x10\n" +
	...
	"\x11WORKLOAD_KIND_POD\x10\a2\xe8\x04\n" +
	"\aKubeAPI\x12Q\n" +
	...
	"\x0fGetCloudVolumes\x12\x1f.kube.v1.GetCloudVolumesRequest\x1a .kube.v1.GetCloudVolumesResponseB&Z$github.com/castai/kvisor/api/kube/v1b\x06proto3"
...
var file_api_v1_kube_kube_api_proto_goTypes = []any{
	...
	(*AWSDiskAttachment)(nil),           // 27: kube.v1.AWSDiskAttachment
	(*AWSCloudVolumeInfo)(nil),          // 28: kube.v1.AWSCloudVolumeInfo
...
var file_api_v1_kube_kube_api_proto_depIdxs = []int32{
	...
	27, // 16: kube.v1.AWSCloudVolumeInfo.attachments:type_name -> kube.v1.AWSDiskAttachment
	28, // 17: kube.v1.CloudVolumeInfo.aws_info:type_name -> kube.v1.AWSCloudVolumeInfo
