...
const file_api_v1_kube_kube_api_proto_rawDesc = "" +
	...
	"\x11WORKLOAD_KIND_POD\x10\a2\x99\x02\n" +
	"\aKubeAPI\x12Q\n" +
	...
	"\aGetNode\x12\x17.kube.v1.GetNodeRequest\x1a\x18.kube.v1.GetNodeResponseB&Z$github.com/castai/kvisor/api/kube/v1b\x06proto3"
...
var file_api_v1_kube_kube_api_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_api_v1_kube_kube_api_proto_goTypes = []any{
	...
	(*GetNodeRequest)(nil),         // 9: kube.v1.GetNodeRequest
	(*GetNodeResponse)(nil),        // 10: kube.v1.GetNodeResponse
	(*Node)(nil),                   // 11: kube.v1.Node
	nil,                            // 12: kube.v1.Node.LabelsEntry
}
var file_api_v1_kube_kube_api_proto_depIdxs = []int32{
	...
	11, // 3: kube.v1.GetNodeResponse.node:type_name -> kube.v1.Node
	12, // 4: kube.v1.Node.labels:type_name -> kube.v1.Node.LabelsEntry
	1,  // 5: kube.v1.KubeAPI.GetClusterInfo:input_type -> kube.v1.GetClusterInfoRequest
	3,  // 6: kube.v1.KubeAPI.GetIPInfo:input_type -> kube.v1.GetIPInfoRequest
	6,  // 7: kube.v1.KubeAPI.GetPod:input_type -> kube.v1.GetPodRequest
	9,  // 8: kube.v1.KubeAPI.GetNode:input_type -> kube.v1.GetNodeRequest
	2,  // 9: kube.v1.KubeAPI.GetClusterInfo:output_type -> kube.v1.GetClusterInfoResponse
	4,  // 10: kube.v1.KubeAPI.GetIPInfo:output_type -> kube.v1.GetIPInfoResponse
	7,  // 11: kube.v1.KubeAPI.GetPod:output_type -> kube.v1.GetPodResponse
	10, // 12: kube.v1.KubeAPI.GetNode:output_type -> kube.v1.GetNodeResponse
