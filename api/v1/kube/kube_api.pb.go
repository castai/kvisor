...
type CloudVolumeInfo struct {
	...
	Iops             uint32                 `protobuf:"varint,8,opt,name=iops,proto3" json:"iops,omitempty"`
	ThroughputBytes  uint32                 `protobuf:"varint,9,opt,name=throughput_bytes,json=throughputBytes,proto3" json:"throughput_bytes,omitempty"`
...
func (x *CloudVolumeInfo) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *CloudVolumeInfo) GetAvailabilityZone() string {
	if x != nil {
...
func (x *CloudVolumeInfo) GetSizeBytes() uint64 {
	if x != nil {
		return x.SizeBytes
	}
	return 0
...
func (x *CloudVolumeInfo) GetIops() uint32 {
	if x != nil {
		return x.Iops
	}
	return 0
...
func (x *CloudVolumeInfo) GetThroughputBytes() uint32 {
	if x != nil {
...
const file_api_v1_kube_kube_api_proto_rawDesc = "" +
	...
	"\avolumes\x18\x01 \x03(\v2\x18.kube.v1.CloudVolumeInfoR\avolumes\"\xda\x02\n" +
	...
	"\tvolume_id\x18\x04 \x01(\tR\bvolumeId\x12\x1f\n" +
	"\vvolume_type\x18\x05 \x01(\tR\n" +
	"volumeType\x12!\n" +
	"\fvolume_state\x18\x06 \x01(\tR\vvolumeState\x12\x1d\n" +
	"\n" +
	"size_bytes\x18\a \x01(\x04R\tsizeBytes\x12\x12\n" +
	"\x04iops\x18\b \x01(\rR\x04iops\x12)\n" +
	"\x10throughput_bytes\x18\t \x01(\rR\x0fthroughputBytes\x12\x1c\n" +
	"\tencrypted\x18\n" +
	" \x01(\bR\tencrypted*\xed\x01\n" +
