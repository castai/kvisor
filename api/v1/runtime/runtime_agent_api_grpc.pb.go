...
const (
	...
	RuntimeSecurityAgentAPI_KubeNodeComponentsIngest_FullMethodName = "/runtime.v1.RuntimeSecurityAgentAPI/KubeNodeComponentsIngest"
)
...
type RuntimeSecurityAgentAPIClient interface {
	...
	KubeNodeComponentsIngest(ctx context.Context, in *KubeNodeComponents, opts ...grpc.CallOption) (*KubeNodeComponentsIngestResponse, error)
}
...
func (c *runtimeSecurityAgentAPIClient) KubeNodeComponentsIngest(ctx context.Context, in *KubeNodeComponents, opts ...grpc.CallOption) (*KubeNodeComponentsIngestResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(KubeNodeComponentsIngestResponse)
	err := c.cc.Invoke(ctx, RuntimeSecurityAgentAPI_KubeNodeComponentsIngest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RuntimeSecurityAgentAPIServer interface {
	...
	KubeNodeComponentsIngest(context.Context, *KubeNodeComponents) (*KubeNodeComponentsIngestResponse, error)
}
...
func (UnimplementedRuntimeSecurityAgentAPIServer) KubeNodeComponentsIngest(context.Context, *KubeNodeComponents) (*KubeNodeComponentsIngestResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method KubeNodeComponentsIngest not implemented")
}
...
func _RuntimeSecurityAgentAPI_KubeNodeComponentsIngest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KubeNodeComponents)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RuntimeSecurityAgentAPIServer).KubeNodeComponentsIngest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RuntimeSecurityAgentAPI_KubeNodeComponentsIngest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RuntimeSecurityAgentAPIServer).KubeNodeComponentsIngest(ctx, req.(*KubeNodeComponents))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RuntimeSecurityAgentAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "KubeNodeComponentsIngest",
			Handler:    _RuntimeSecurityAgentAPI_KubeNodeComponentsIngest_Handler,
		},
	},
