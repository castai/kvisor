...
func (c *runtimeSecurityAgentAPIClient) ContainerStatsWriteStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[ContainerStatsBatch, WriteStreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[ContainerStatsBatch, WriteStreamResponse]{ClientStream: stream}
	return x, nil
}
...
type RuntimeSecurityAgentAPIServer interface {
	...
	ContainerStatsWriteStream(grpc.ClientStreamingServer[ContainerStatsBatch, WriteStreamResponse]) error
...
func (UnimplementedRuntimeSecurityAgentAPIServer) ContainerStatsWriteStream(grpc.ClientStreamingServer[ContainerStatsBatch, WriteStreamResponse]) error {
...
func _RuntimeSecurityAgentAPI_ContainerStatsWriteStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RuntimeSecurityAgentAPIServer).ContainerStatsWriteStream(&grpc.GenericServerStream[ContainerStatsBatch, WriteStreamResponse]{ServerStream: stream})
}
