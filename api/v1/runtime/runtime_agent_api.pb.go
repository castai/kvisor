...
type KubeNodeComponents_ComponentName int32

const (
	KubeNodeComponents_COMPONENT_NAME_UNKNOWN    KubeNodeComponents_ComponentName = 0
	KubeNodeComponents_COMPONENT_NAME_KUBELET    KubeNodeComponents_ComponentName = 1
	KubeNodeComponents_COMPONENT_NAME_KUBERNETES KubeNodeComponents_ComponentName = 2
	KubeNodeComponents_COMPONENT_NAME_PROXY      KubeNodeComponents_ComponentName = 3
)

// Enum value maps for KubeNodeComponents_ComponentName.
var (
	KubeNodeComponents_ComponentName_name = map[int32]string{
		0: "COMPONENT_NAME_UNKNOWN",
		1: "COMPONENT_NAME_KUBELET",
		2: "COMPONENT_NAME_KUBERNETES",
		3: "COMPONENT_NAME_PROXY",
	}
	KubeNodeComponents_ComponentName_value = map[string]int32{
		"COMPONENT_NAME_UNKNOWN":    0,
		"COMPONENT_NAME_KUBELET":    1,
		"COMPONENT_NAME_KUBERNETES": 2,
		"COMPONENT_NAME_PROXY":      3,
	}
)

func (x KubeNodeComponents_ComponentName) Enum() *KubeNodeComponents_ComponentName {
	p := new(KubeNodeComponents_ComponentName)
	*p = x
	return p
}

func (x KubeNodeComponents_ComponentName) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (KubeNodeComponents_ComponentName) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_runtime_runtime_agent_api_proto_enumTypes[4].Descriptor()
}

func (KubeNodeComponents_ComponentName) Type() protoreflect.EnumType {
	return &file_api_v1_runtime_runtime_agent_api_proto_enumTypes[4]
}

func (x KubeNodeComponents_ComponentName) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use KubeNodeComponents_ComponentName.Descriptor instead.
func (KubeNodeComponents_ComponentName) EnumDescriptor() ([]byte, []int) {
	return file_api_v1_runtime_runtime_agent_api_proto_rawDescGZIP(), []int{34, 0}
}

type KubeNodeComponents_ConfigType int32

const (
	KubeNodeComponents_CONFIG_TYPE_UNKNOWN    KubeNodeComponents_ConfigType = 0
	KubeNodeComponents_CONFIG_TYPE_CONF       KubeNodeComponents_ConfigType = 1
	KubeNodeComponents_CONFIG_TYPE_KUBECONFIG KubeNodeComponents_ConfigType = 2
	KubeNodeComponents_CONFIG_TYPE_AZURE_JSON KubeNodeComponents_ConfigType = 3
)

// Enum value maps for KubeNodeComponents_ConfigType.
var (
	KubeNodeComponents_ConfigType_name = map[int32]string{
		0: "CONFIG_TYPE_UNKNOWN",
		1: "CONFIG_TYPE_CONF",
		2: "CONFIG_TYPE_KUBECONFIG",
		3: "CONFIG_TYPE_AZURE_JSON",
	}
	KubeNodeComponents_ConfigType_value = map[string]int32{
		"CONFIG_TYPE_UNKNOWN":    0,
		"CONFIG_TYPE_CONF":       1,
		"CONFIG_TYPE_KUBECONFIG": 2,
		"CONFIG_TYPE_AZURE_JSON": 3,
	}
)

func (x KubeNodeComponents_ConfigType) Enum() *KubeNodeComponents_ConfigType {
	p := new(KubeNodeComponents_ConfigType)
	*p = x
	return p
}

func (x KubeNodeComponents_ConfigType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (KubeNodeComponents_ConfigType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_runtime_runtime_agent_api_proto_enumTypes[5].Descriptor()
}

func (KubeNodeComponents_ConfigType) Type() protoreflect.EnumType {
	return &file_api_v1_runtime_runtime_agent_api_proto_enumTypes[5]
}

func (x KubeNodeComponents_ConfigType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use KubeNodeComponents_ConfigType.Descriptor instead.
func (KubeNodeComponents_ConfigType) EnumDescriptor() ([]byte, []int) {
	return file_api_v1_runtime_runtime_agent_api_proto_rawDescGZIP(), []int{34, 1}
}

type KubeNodeComponents_ConfigSource int32

const (
	KubeNodeComponents_CONFIG_SOURCE_UNKNOWN KubeNodeComponents_ConfigSource = 0
	KubeNodeComponents_CONFIG_SOURCE_FILE    KubeNodeComponents_ConfigSource = 1
	KubeNodeComponents_CONFIG_SOURCE_API     KubeNodeComponents_ConfigSource = 2
)

// Enum value maps for KubeNodeComponents_ConfigSource.
var (
	KubeNodeComponents_ConfigSource_name = map[int32]string{
		0: "CONFIG_SOURCE_UNKNOWN",
		1: "CONFIG_SOURCE_FILE",
		2: "CONFIG_SOURCE_API",
	}
	KubeNodeComponents_ConfigSource_value = map[string]int32{
		"CONFIG_SOURCE_UNKNOWN": 0,
		"CONFIG_SOURCE_FILE":    1,
		"CONFIG_SOURCE_API":     2,
	}
)

func (x KubeNodeComponents_ConfigSource) Enum() *KubeNodeComponents_ConfigSource {
	p := new(KubeNodeComponents_ConfigSource)
	*p = x
	return p
}

func (x KubeNodeComponents_ConfigSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (KubeNodeComponents_ConfigSource) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_runtime_runtime_agent_api_proto_enumTypes[6].Descriptor()
}

func (KubeNodeComponents_ConfigSource) Type() protoreflect.EnumType {
	return &file_api_v1_runtime_runtime_agent_api_proto_enumTypes[6]
}

func (x KubeNodeComponents_ConfigSource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use KubeNodeComponents_ConfigSource.Descriptor instead.
func (KubeNodeComponents_ConfigSource) EnumDescriptor() ([]byte, []int) {
...
func (x *KubeNodeComponents) Reset() {
	*x = KubeNodeComponents{}
	mi := &file_api_v1_runtime_runtime_agent_api_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *KubeNodeComponents) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KubeNodeComponents) ProtoMessage() {}

func (x *KubeNodeComponents) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_runtime_runtime_agent_api_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KubeNodeComponents.ProtoReflect.Descriptor instead.
func (*KubeNodeComponents) Descriptor() ([]byte, []int) {
...
type KubeNodeComponentsIngestResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *KubeNodeComponentsIngestResponse) Reset() {
	*x = KubeNodeComponentsIngestResponse{}
	mi := &file_api_v1_runtime_runtime_agent_api_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *KubeNodeComponentsIngestResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KubeNodeComponentsIngestResponse) ProtoMessage() {}

func (x *KubeNodeComponentsIngestResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_runtime_runtime_agent_api_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KubeNodeComponentsIngestResponse.ProtoReflect.Descriptor instead.
func (*KubeNodeComponentsIngestResponse) Descriptor() ([]byte, []int) {
...
type KubeNodeComponents_NodeComponent struct {
	...
	Name KubeNodeComponents_ComponentName `protobuf:"varint,1,opt,name=name,proto3,enum=runtime.v1.KubeNodeComponents_ComponentName" json:"name,omitempty"`
	// Type of configuration
	ConfigType KubeNodeComponents_ConfigType `protobuf:"varint,2,opt,name=config_type,json=configType,proto3,enum=runtime.v1.KubeNodeComponents_ConfigType" json:"config_type,omitempty"`
	// File metadata (path, permissions, ownership)
	ConfigFile *KubeNodeComponents_ConfigFile `protobuf:"bytes,3,opt,name=config_file,json=configFile,proto3,oneof" json:"config_file,omitempty"`
	// Configuration content (source, content, hash)
	ConfigData    *KubeNodeComponents_ConfigData `protobuf:"bytes,4,opt,name=config_data,json=configData,proto3,oneof" json:"config_data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *KubeNodeComponents_NodeComponent) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *KubeNodeComponents_NodeComponent) GetName() KubeNodeComponents_ComponentName {
	...
	return KubeNodeComponents_COMPONENT_NAME_UNKNOWN
}

func (x *KubeNodeComponents_NodeComponent) GetConfigType() KubeNodeComponents_ConfigType {
	if x != nil {
		return x.ConfigType
	}
	return KubeNodeComponents_CONFIG_TYPE_UNKNOWN
}

func (x *KubeNodeComponents_NodeComponent) GetConfigFile() *KubeNodeComponents_ConfigFile {
	if x != nil {
		return x.ConfigFile
	}
	return nil
...
func (x *KubeNodeComponents_NodeComponent) GetConfigData() *KubeNodeComponents_ConfigData {
	if x != nil {
		return x.ConfigData
	}
	return nil
...
type KubeNodeComponents_ConfigFile struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Absolute path to the file on the node filesystem
...
func (x *KubeNodeComponents_ConfigFile) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *KubeNodeComponents_ConfigFile) GetMode() uint32 {
	if x != nil {
		return x.Mode
	}
	return 0
...
func (x *KubeNodeComponents_ConfigFile) GetUid() uint32 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *KubeNodeComponents_ConfigFile) GetGid() uint32 {
	if x != nil {
		return x.Gid
	}
	return 0
...
type KubeNodeComponents_ConfigData struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Source of the configuration data
	Source KubeNodeComponents_ConfigSource `protobuf:"varint,1,opt,name=source,proto3,enum=runtime.v1.KubeNodeComponents_ConfigSource" json:"source,omitempty"`
...
func (x *KubeNodeComponents_ConfigData) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *KubeNodeComponents_ConfigData) GetSource() KubeNodeComponents_ConfigSource {
	...
	return KubeNodeComponents_CONFIG_SOURCE_UNKNOWN
}

func (x *KubeNodeComponents_ConfigData) GetContent() []byte {
	if x != nil {
		return x.Content
	}
	return nil
...
func (x *KubeNodeComponents_ConfigData) GetHash() string {
	if x != nil {
		return x.Hash
	}
	return ""
...
const file_api_v1_runtime_runtime_agent_api_proto_rawDesc = "" +
	...
	"configType\x12O\n" +
	"\vconfig_file\x18\x03 \x01(\v2).runtime.v1.KubeNodeComponents.ConfigFileH\x00R\n" +
	"configFile\x88\x01\x01\x12O\n" +
	"\vconfig_data\x18\x04 \x01(\v2).runtime.v1.KubeNodeComponents.ConfigDataH\x01R\n" +
	"configData\x88\x01\x01B\x0e\n" +
	"\f_config_fileB\x0e\n" +
	"\f_config_data\x1aX\n" +
	"\n" +
	"ConfigFile\x12\x12\n" +
	...
	"\x03gid\x18\x04 \x01(\rR\x03gid\x1a\x7f\n" +
	"\n" +
	"ConfigData\x12C\n" +
	"\x06source\x18\x01 \x01(\x0e2+.runtime.v1.KubeNodeComponents.ConfigSourceR\x06source\x12\x18\n" +
	"\acontent\x18\x02 \x01(\fR\acontent\x12\x12\n" +
	"\x04hash\x18\x03 \x01(\tR\x04hash\"\x80\x01\n" +
	"\rComponentName\x12\x1a\n" +
	"\x16COMPONENT_NAME_UNKNOWN\x10\x00\x12\x1a\n" +
	"\x16COMPONENT_NAME_KUBELET\x10\x01\x12\x1d\n" +
	"\x19COMPONENT_NAME_KUBERNETES\x10\x02\x12\x18\n" +
	"\x14COMPONENT_NAME_PROXY\x10\x03\"s\n" +
	"\n" +
	"ConfigType\x12\x17\n" +
	"\x13CONFIG_TYPE_UNKNOWN\x10\x00\x12\x14\n" +
	"\x10CONFIG_TYPE_CONF\x10\x01\x12\x1a\n" +
	"\x16CONFIG_TYPE_KUBECONFIG\x10\x02\x12\x1a\n" +
	"\x16CONFIG_TYPE_AZURE_JSON\x10\x03\"X\n" +
	"\fConfigSource\x12\x19\n" +
	"\x15CONFIG_SOURCE_UNKNOWN\x10\x00\x12\x16\n" +
	"\x12CONFIG_SOURCE_FILE\x10\x01\x12\x15\n" +
	"\x11CONFIG_SOURCE_API\x10\x02\"\"\n" +
	" KubeNodeComponentsIngestResponse*\xf0\x02\n" +
	"\tEventType\x12\v\n" +
	...
	"\x13PROCESS_ACTION_EXIT\x10\x032\xe8\x06\n" +
	...
	"\x16KubeLinterReportIngest\x12\x1c.runtime.v1.KubeLinterReport\x1a*.runtime.v1.KubeLinterReportIngestResponse\"\x00\x12j\n" +
	"\x18KubeNodeComponentsIngest\x12\x1e.runtime.v1.KubeNodeComponents\x1a,.runtime.v1.KubeNodeComponentsIngestResponse\"\x00B*Z(github.com/castai/kvisord/api/runtime/v1b\x06proto3"
...
var file_api_v1_runtime_runtime_agent_api_proto_goTypes = []any{
	...
	(KubeNodeComponents_ComponentName)(0),    // 4: runtime.v1.KubeNodeComponents.ComponentName
	(KubeNodeComponents_ConfigType)(0),       // 5: runtime.v1.KubeNodeComponents.ConfigType
	(KubeNodeComponents_ConfigSource)(0),     // 6: runtime.v1.KubeNodeComponents.ConfigSource
	(*WriteDataBatchRequest)(nil),            // 7: runtime.v1.WriteDataBatchRequest
	(*WriteDataBatchResponse)(nil),           // 8: runtime.v1.WriteDataBatchResponse
	(*DataBatchItem)(nil),                    // 9: runtime.v1.DataBatchItem
	(*GetConfigurationRequest)(nil),          // 10: runtime.v1.GetConfigurationRequest
	(*GetConfigurationResponse)(nil),         // 11: runtime.v1.GetConfigurationResponse
	(*Configuration)(nil),                    // 12: runtime.v1.Configuration
	(*ProcessIdentity)(nil),                  // 13: runtime.v1.ProcessIdentity
	(*ContainerEvents)(nil),                  // 14: runtime.v1.ContainerEvents
	(*ContainerEvent)(nil),                   // 15: runtime.v1.ContainerEvent
	(*WriteStreamResponse)(nil),              // 16: runtime.v1.WriteStreamResponse
	(*SendLogsResponse)(nil),                 // 17: runtime.v1.SendLogsResponse
	(*ContainerStats)(nil),                   // 18: runtime.v1.ContainerStats
	(*FilesAccessStats)(nil),                 // 19: runtime.v1.FilesAccessStats
	(*NodeStats)(nil),                        // 20: runtime.v1.NodeStats
	(*ImageMetadata)(nil),                    // 21: runtime.v1.ImageMetadata
	(*ImageMetadataIngestResponse)(nil),      // 22: runtime.v1.ImageMetadataIngestResponse
	(*GetSyncStateRequest)(nil),              // 23: runtime.v1.GetSyncStateRequest
	(*GetSyncStateResponse)(nil),             // 24: runtime.v1.GetSyncStateResponse
	(*ImagesSyncState)(nil),                  // 25: runtime.v1.ImagesSyncState
	(*Image)(nil),                            // 26: runtime.v1.Image
	(*UpdateSyncStateRequest)(nil),           // 27: runtime.v1.UpdateSyncStateRequest
	(*UpdateSyncStateResponse)(nil),          // 28: runtime.v1.UpdateSyncStateResponse
	(*KubeBenchReport)(nil),                  // 29: runtime.v1.KubeBenchReport
	(*KubeBenchReportIngestResponse)(nil),    // 30: runtime.v1.KubeBenchReportIngestResponse
	(*KubeBenchNode)(nil),                    // 31: runtime.v1.KubeBenchNode
	(*KubeBenchControls)(nil),                // 32: runtime.v1.KubeBenchControls
	(*KubeBenchGroup)(nil),                   // 33: runtime.v1.KubeBenchGroup
	(*KubeBenchCheck)(nil),                   // 34: runtime.v1.KubeBenchCheck
	(*KubeLinterReport)(nil),                 // 35: runtime.v1.KubeLinterReport
	(*KubeLinterReportIngestResponse)(nil),   // 36: runtime.v1.KubeLinterReportIngestResponse
	(*KubeLinterCheck)(nil),                  // 37: runtime.v1.KubeLinterCheck
	(*Process)(nil),                          // 38: runtime.v1.Process
	(*ProcessEvent)(nil),                     // 39: runtime.v1.ProcessEvent
	(*ProcessTreeEvent)(nil),                 // 40: runtime.v1.ProcessTreeEvent
	(*KubeNodeComponents)(nil),               // 41: runtime.v1.KubeNodeComponents
...
var file_api_v1_runtime_runtime_agent_api_proto_depIdxs = []int32{
	...
	43, // 8: runtime.v1.ContainerEvents.object_labels:type_name -> runtime.v1.ContainerEvents.ObjectLabelsEntry
	...
	26, // 34: runtime.v1.UpdateSyncStateRequest.images:type_name -> runtime.v1.Image
	32, // 35: runtime.v1.KubeBenchReport.controls:type_name -> runtime.v1.KubeBenchControls
	31, // 36: runtime.v1.KubeBenchReport.node:type_name -> runtime.v1.KubeBenchNode
	33, // 37: runtime.v1.KubeBenchControls.groups:type_name -> runtime.v1.KubeBenchGroup
	34, // 38: runtime.v1.KubeBenchGroup.checks:type_name -> runtime.v1.KubeBenchCheck
	37, // 39: runtime.v1.KubeLinterReport.checks:type_name -> runtime.v1.KubeLinterCheck
